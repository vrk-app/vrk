...
type Standard struct {
	ID                           *uuid.UUID
	EquipmentID                  uuid.UUID
	StandardsDictionaryID        *uuid.UUID
	CertificateNumber            *string
	LastOperationDate            *time.Time
	NextOperationDate            *time.Time
	DocumentProviderOrganization *string
...
type CreateRequest struct {
	...
	StatusID              int32   `json:"statusId" validate:"required,min=1,max=5"`
	...
	// Для эталонов
	Standards []StandardCreateRequest `json:"standards,omitempty"`
}
...
type UpdateRequest struct {
	...
	// Эталоны
	Standards []StandardUpdateRequest `json:"standards,omitempty"`
}
...
type EquipmentResponse struct {
	...
	Standards           []StandardInfo           `json:"standards,omitempty"`
}
