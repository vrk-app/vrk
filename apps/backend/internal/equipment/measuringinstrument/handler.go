...
// @Accept       json
// @Produce      json
// @Param        request body CreateRequest true "Measuring instrument payload"
// @Success      201  {object}  Response{data=MeasuringInstrumentResponse}
...
// @Success      200     {object}  Response{data=[]MeasuringInstrumentResponse,meta=Meta}
// @Failure      401     {object}  Response
// @Failure      403     {object}  Response
...
// @Success      200  {object}  Response{data=MeasuringInstrumentResponse}
// @Failure      401  {object}  Response
// @Failure      403  {object}  Response
...
// @Produce      json
// @Param        id path string true "Measuring instrument ID"
// @Param        request body UpdateRequest true "Measuring instrument patch payload"
// @Success      200  {object}  Response{data=MeasuringInstrumentResponse}
// @Failure      400  {object}  Response
// @Failure      401  {object}  Response
// @Failure      403  {object}  Response
// @Failure      404  {object}  Response
// @Router       /measuring-instruments/{id} [patch]
...
// @Failure      403  {object}  Response
// @Failure      404  {object}  Response
// @Router       /measuring-instruments/{id}/journals [get]
func (h *MeasuringInstrumentHandler) ListJournals(w http.ResponseWriter, r *http.Request) {
	token, err := readBearerToken(r)
	if err != nil {
		sendError(w, http.StatusUnauthorized, "missing bearer token")
		return
...
// @Failure      403  {object}  Response
// @Failure      404  {object}  Response
// @Router       /measuring-instruments/{id}/journals [post]
func (h *MeasuringInstrumentHandler) CreateJournal(w http.ResponseWriter, r *http.Request) {
	token, err := readBearerToken(r)
	if err != nil {
		sendError(w, http.StatusUnauthorized, "missing bearer token")
		return
...
// @Failure      403  {object}  Response
// @Failure      404  {object}  Response
// @Router       /measuring-instruments/{id}/archive [post]
func (h *MeasuringInstrumentHandler) Archive(w http.ResponseWriter, r *http.Request) {
	token, err := readBearerToken(r)
	if err != nil {
		sendError(w, http.StatusUnauthorized, "missing bearer token")
		return
...
func writeServiceError(w http.ResponseWriter, err error) {
	...
	case errors.Is(err, ErrInvalidID),
		...
		errors.Is(err, ErrRegistrationNumberRequired),
		errors.Is(err, ErrSerialNumberRequired),
		errors.Is(err, ErrUnitRequired),
		errors.Is(err, ErrPlacementKindRequired),
		errors.Is(err, ErrPlacementKindInvalid),
		errors.Is(err, ErrEquipmentRequired),
		errors.Is(err, ErrEquipmentInvalid),
		errors.Is(err, ErrStandardInvalid),
