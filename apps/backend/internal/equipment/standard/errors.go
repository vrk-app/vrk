...
var (
	...
	ErrDiagnosticEquipmentRequired = errors.New("diagnostic equipment is required")
	ErrDiagnosticEquipmentInvalid  = errors.New("diagnostic equipment is invalid for current scope")
