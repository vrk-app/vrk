...
const docTemplate = `{
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/bootstrap.EmployeeAccessResponse"
                                            }
                                        }
                                    }
                                }
        ...
        "/employees/{accessID}": {
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Scoped access ID",
                        "name": "accessID",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Employee access update payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bootstrap.UpdateEmployeeAccessRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "bootstrap.EmployeeAccessResponse": {
            "type": "object",
            "properties": {
                "accessId": {
                    "type": "string"
        ...
        "bootstrap.UpdateEmployeeAccessRequest": {
            "type": "object",
            "properties": {
                "roleTemplate": {
                    "type": "string"
