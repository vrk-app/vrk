...
SUMMARY_PATH = RAW_DIR / "slice-007-008-final-fresh-verifier-live-summary-2026-04-21.json"
...
def main() -> int:
    ...
    shared_email = f"shared-final-{SEED}@vrk.local"
    initial_password = f"stage03-initial-{SEED}"
    multi_access_password = f"stage03-multi-{SEED}"
    alpha = create_first_admin("alpha-final", shared_email, initial_password)
    beta = create_first_admin("beta-final", f"beta-final-{SEED}@vrk.local", f"stage03-beta-{SEED}")
